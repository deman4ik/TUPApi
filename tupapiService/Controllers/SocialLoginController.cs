...
namespace tupapiService.Controllers
{
    ...
    public class SocialLoginController : ApiController
    {
        ...
        public HttpResponseMessage Login([FromUri] string code = null,
            ...
            [FromUri] string error = null, [FromUri] string error_reason = null,
            [FromUri] string error_description = null)
        {
            if (!string.IsNullOrWhiteSpace(error))
                return Request.CreateResponse(HttpStatusCode.BadRequest,
                    "Error: " + error + " Error reason: " + error_reason + " Error description: " + error_description);

            return Request.CreateResponse(HttpStatusCode.OK,
                new AccessToken("Code :" + code + " Grant type: " + grant_type + "Redirect Uri: " + redirect_uri +
                                "Client id: " + client_id + "Client_secret: " + client_secret));
        }
    }
}